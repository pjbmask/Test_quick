...
class OutlookEmailSender:
    ...
    def create_email_body(self, file_count):
        """
        이메일 본문 생성
...
Please refer to the attached email and complete the K-SOX training and test as requested.
...
"""
    ...
    def process_all(self, subject_template="[Reminder] K-SOX Training and Test Completion Request"):
        """
        전체 이메일 발송 프로세스 실행
        ...
        for idx, row in df.iterrows():
            ...
            # 이메일 본문 생성
            body = self.create_email_body(len(valid_files))
